...
VERSION ?= 3.0.0
IMAGE_TAG ?= 3.0.0
REDUCED_VERSION ?= 3.0.0-snapshot
...
CHANNELS="stable,stable-v1.0,stable-v1.1,stable-v3"
...
IMAGE_TAG_BASE ?= registry.redhat.io/rhtpa/rhtpa-rhel10-operator
#IMAGE_DIGEST ?=
...
bundle-push: ## Push the bundle image.
	$(MAKE) $(BUILDER)-push IMG=$(BUNDLE_IMG)
...
catalog-push: ## Push a catalog image.
	$(MAKE) $(BUILDER) -push IMG=$(CATALOG_IMG)
