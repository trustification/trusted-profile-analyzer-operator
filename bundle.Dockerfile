...
LABEL version="1.2.0"
LABEL release=1.2.0
LABEL cpe="cpe:/a:redhat:trusted_profile_analyzer:2.3::el9"
...
LABEL operators.operatorframework.io.bundle.channels.v1=stable,stable-v1.0,stable-v1.1,stable-v1.2
